...
chronometer.add = function() {
	...
	$(chronometer.element)[0].textContent = (chronometer.hours ? (chronometer.hours > 9 ? chronometer.hours : "0" + chronometer.hours) : "00") + "h " + (chronometer.minutes ? (chronometer.minutes > 9 ? chronometer.minutes + "m" : "0" + chronometer.minutes + "m") : "00m");
